...
export interface IWordManagementProps extends StateProps, DispatchProps, RouteComponentProps<{}> {}

export const WordManagement = (props: IWordManagementProps) => {
  ...
  return (
    <div>
      <h2 id="word-management-page-heading">
...
export default connect(mapStateToProps, mapDispatchToProps)(WordManagement);
